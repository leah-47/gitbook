---
title: "How to manage resources in Local Library?"
source_url: https://docs.d5render.com/user-guide/assets/how-to-manage-resources-in-local-library
fetched: 2026-06-07
---
...
**The left sidebar enables you to customize the categories, while the right-click menu provides options to create, delete, and rename custom categories.**
...
1. ****\[Versions earlier than 2.11]******:** In the upper left corner of the D5 Render, go to **“Menu” > “Preferences” > “Assets Storage” > "Current Location"**, and find the current storage location of the assets file.\ ****\[Versions 2.11 and later]******:** In D5 Launcher, go to **“Setting” > "Workspace"**, and find the current storage location of the assets file.
2. Package and copy the files to another computer and remember the path on that PC.
3. ****\[Versions earlier than 2.11]******:** Reassign the **“Menu” > “Preferences” > “Assets Storage” >"Select Location"** on the new computer to reassign it to the assets file’s current location.\ ****\[Versions 2.11 and later]******:** In D5 Launcher, go to **“Setting” > "Workspace"**, and select a new location to relocate.
...
2. **If you are uninstalling and then reinstalling**, \ ****\[Versions earlier than 2.11]******:** you will need to reassign the storage location to the assets file in the upper right corner of the D5 Render in the **“Menu” > “Preferences” > “Assets Storage” > "Select Location"**, then restart D5 Render.\ ****\[Versions 2.11 and later]******:** In D5 Launcher, go to **“Setting” > "Workspace"**, then select a new location to relocate, and restart the D5 Render.
