...
1. Click the corresponding icon button in the navigation bar to place it in the scene, or use the shortcut keys `1`, `2`, `3`, `4`,`5` to quickly place **Point Light**, **Spotlight**, **Strip Light**, **Rect Light** and ****Disc Light****, respectively.
