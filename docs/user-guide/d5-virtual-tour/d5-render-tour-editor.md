---
title: "D5 Render Tour Editor"
source_url: https://docs.d5render.com/user-guide/d5-virtual-tour/d5-render-tour-editor
fetched: 2026-06-07
---

# D5 Render Tour Editor

You can find the corresponding virtual tour files within the D5 Showreel in MySpace, and click 'Edit' to enter the Panorama Editor.
...
Bind a panorama scene in the current panorama tour sequence. Click on the type of Hotspot will jump to another panorama scene.

**Rich Media Hotspot**

Support editing a rich text, users can add images, videos and hyperlinks. After clicking this type of hotspot, a pop-up window will be opened.
...
Images: Up to 20 photos can be added, up to 100MB per photo. Supported formats: JPG, JPEG, GIF, PNG, WebP, BMP&#x20;

Hyperlink: Supports entering a valid URL beginning with http/https&#x20;
...
**Offset Position:** Hotspots can only be adsorbed on the surface of the object in spacial tours, and the offset position can be used to adjust the hotspot position in the x, y and z directions.&#x20;

**Hotspot style** \
Normal direction: I .e. the direction of the surface of the object \
&#x20;  \- Self rotation: Enter a value to change the icon direction \
&#x20; \-  Face the screen: The icon is facing the screen. Spatial tour defaults to normal. Panoramic tour defaults to face the screen and cannot be adjusted.&#x20;

**Hotspot Image:** Provides a variety of static and dynamic icons for choice.&#x20;
...
&#x20;      \- Spatial Tour: Anchors record XYZ coordinates and stay visible within range when transitioning between scenes.

&#x20;      \- Panorama Tour: Anchors record XY coordinates and are only visible when the corresponding scene is selected.
...
3. **Comment integration and management**
